...
export default function ProofDetailPage({
    ...
    const proof = proofData as
        | {
            ...
            isActive: boolean;
            timestamp: bigint;
            ipfsCid: string; // Assuming this is part of the struct, adjust if strictly following ABI
        }
        | undefined;
    ...
    return (
        <main className="min-h-screen bg-gray-50 py-12 px-4 flex flex-col items-center">
            ...
            {/* Certificate Card */}
            <div className="bg-white w-full max-w-2xl rounded-3xl shadow-xl overflow-hidden border-4 border-double border-blue-100 relative print:shadow-none print:border-4 print:border-black">
                {/* Decorative Corner */}
